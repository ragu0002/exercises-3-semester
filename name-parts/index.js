...
console.log("firstName", firstName);
const middleName = fullName.substring(indexOfFirst + 1, fullName.indexOf(searchTerm, indexOfFirst + 1));
console.log("middleName", middleName);

const lastName = fullName.substring(fullName.indexOf(searchTerm, fullName.indexOf(searchTerm) + 1) + 1);
console.log("lastName", lastName);
